"""Merge every .md file in /front-end/sequence/wire-flow/ into
sequence-wire-flow-TEMPORARY.md.

The index that used to live in sequence-wire-flow.md is now embedded in
...
rewritten from external file references to internal anchors:
    ...
    [phase-1-initialization.md](phase-1-initialization.md)
    → [phase-1-initialization.md](#phase-1--initialization)
...
A stale sequence-wire-flow-TEMPORARY.md is deleted before the merge runs,
